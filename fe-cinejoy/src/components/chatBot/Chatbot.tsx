    ...
    return (
        <>
            ...
            {showScrollTop && (
                ...
                className={`fixed ${isMenuOpen ? "bottom-60" : "bottom-40"} right-5 z-[9999] bg-blue-600 hover:bg-blue-800 text-white p-3.5 rounded-full shadow-lg transition-all duration-300 cursor-pointer`}
                title="Lên đầu trang"
                >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
