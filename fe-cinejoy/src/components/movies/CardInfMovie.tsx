            ...
            >
                ...
                <div className="flex flex-col md:flex-row items-start max-w-5xl mx-auto bg-black/40 rounded-xl p-8 gap-10">
                    ...
                    <div className="min-w-[280px] text-center">
                        ...
                        `}
                            disabled={movie?.status !== "nowShowing" && movie?.status !== "special"}
                    ...
                    <div className="flex-1 text-white">
                        <h2 className="text-4xl font-bold text-lime-300 mb-2">{movie?.title}</h2>
                        ...
                        <div className="text-lg mb-1">
                            <span className="text-yellow-300">Ngày phát hành :
                        ...
                        <div className="text-lg mb-1">
                            <span className="text-yellow-300">Diễn viên :</span> {movie?.actors.join(", ")}
                        </div>

                        <div className="text-lg mb-1">
                            <span className="text-yellow-300">Thể loại :</span> {movie?.genre.join(", ")}
                        </div>
                        <div className="text-lg mb-1">
