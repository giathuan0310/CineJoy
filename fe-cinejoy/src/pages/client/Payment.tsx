      ...
      >
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-8">
          ...
          >
            <div className="flex items-center justify-between -mt-2">
              <div className="flex gap-2">
                <button
                  ...
                  className={`flex items-center gap-1 px-2 py-1 rounded-lg font-medium select-none cursor-pointer transition-all duration-200 ${isDarkMode
            ...
            {/* Dịch vụ kèm */}
            <h3
              className={`text-lg font-bold text-center mb-2 ${isDarkMode ? "text-cyan-400" : "text-blue-700"
                }`}
            >
              Dịch vụ kèm
            </h3>
            {combosLoading ? (
              ...
              <div
                className={`rounded-lg overflow-hidden mb-4 ${isDarkMode ? "bg-[#23272f]" : "bg-white"
              ...
              >
                <table className={`w-full ${isDarkMode ? "" : "bg-[#e7ede7]"}`}>
                  <thead className="sticky top-0 z-10">
                    <tr
                      className={`text-left select-none border-b ${isDarkMode ? "border-gray-600 bg-[#1a1f2e]" : "border-gray-300 bg-gray-50"
                        }`}
                    >
                      <th
                        className={`py-2 text-center font-bold ${isDarkMode ? "text-white" : ""
                          }`}
                      >
                        Sản phẩm/Combo
                      </th>
                  ...
                  <tbody>
                    {combos.map((c) => (
                      <tr
                        key={c._id}
                        className={`select-none transition-colors duration-200 ${c.quantity === 0 ? "opacity-60" : ""
                          }`}
                      >
                        <td className="py-3 font-semibold text-center">
                          <div
                            className={`text-base ${c.quantity === 0 ? "text-gray-500" : ""
                              }`}
                          >
                            {c.name}
                          </div>
                        ...
                        <td className="py-3 text-center">
                          <span
                            className={`font-bold text-base ${c.quantity === 0
                              ? "text-gray-500"
                              : isDarkMode
                                ? "text-green-400"
                                : "text-green-600"
                        ...
                        <td className="py-1 text-center">
                          <div className="flex items-center justify-center gap-2">
                            <button
                              ...
                              className={`w-8 h-8 rounded-full flex items-center justify-center font-bold text-lg transition-all duration-200 ${(comboCounts[c._id] || 0) <= 0
                            ...
                            <button
                              ...
                              className={`w-8 h-8 rounded-full flex items-center justify-center font-bold text-lg transition-all duration-200 ${(comboCounts[c._id] || 0) >= c.quantity
                                ? "bg-gray-300 text-gray-500 cursor-not-allowed"
                                : isDarkMode
            ...
            <h3
              className={`text-lg font-bold text-center mt-8 mb-3 ${isDarkMode ? "text-cyan-400" : "text-blue-700"
                }`}
            >
              Phương thức thanh toán
            </h3>
            ...
            <div className="mb-4">
              <div className="space-y-3">
                {/* MOMO */}
                <label className={`flex items-center p-3 rounded-lg border cursor-pointer transition-all duration-200 ${paymentMethod === 'MOMO'
                  ? isDarkMode
                ...
                {/* VNPAY */}
                <label className={`flex items-center p-3 rounded-lg border cursor-pointer transition-all duration-200 ${paymentMethod === 'VNPAY'
                  ? isDarkMode
                    ? 'bg-blue-900/30 border-blue-500'
            ...
            <div className="flex justify-between items-center mb-4 mt-6 px-20">
              ...
              <div className="flex flex-col items-center">
                ...
                <span
                  className={`px-4 py-1 mt-1 rounded font-bold ${timeLeft <= 60
          ...
          >
            <div className="detail_movie_container">
              ...
              />
              <p
                className={`detail_movie_title text-lg font-semibold text-center mb-4 ${isDarkMode ? "text-cyan-400" : "text-blue-700"
                  }`}
              >
              ...
              <div className="detail_movie_info space-y-2">
                ...
                <div className="mt-4">
                  ...
                  {!appliedVoucher ? (
                    <div className="mb-3">
                      <div className="flex items-center gap-2">
                        <input
                          ...
                          className={`flex-1 border rounded-md px-2.5 py-2 h-10 ${isDarkMode
                        ...
                        <button
                          ...
                          className={`px-2 py-2 rounded font-semibold transition-all duration-200 h-10 whitespace-nowrap ${voucherLoading || !voucherCode.trim()
                    ...
                    <div className={`border rounded p-3 mb-2 ${isDarkMode ? 'bg-[#232c3b] border-[#3a3d46]' : 'bg-green-50 border-green-300'
                      }`}>
              ...
              <button
                className={`mt-6 w-full px-6 py-2 rounded font-semibold transition-all duration-200 cursor-pointer ${isDarkMode
